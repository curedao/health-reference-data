...
CREATE TABLE `cd_variables` (
  ...
  `ref_aact_id` int(10) unsigned DEFAULT NULL COMMENT '[]',
  `ref_gene_ontology_id` int(10) unsigned DEFAULT NULL COMMENT '[]',
  `ref_hmdb_id` int(10) unsigned DEFAULT NULL COMMENT '[]',
  `ref_icd10_id` int(10) unsigned DEFAULT NULL COMMENT '[]',
  `ref_loinc_id` int(10) unsigned DEFAULT NULL COMMENT '[]',
  `ref_meddra_all_indications_id` int(10) unsigned DEFAULT NULL COMMENT '[]',
  `ref_meddra_all_side_effects_id` int(10) unsigned DEFAULT NULL COMMENT '[]',
  `ref_rxnorm_id` int(10) unsigned DEFAULT NULL COMMENT '[]',
  `ref_snomed_id` int(10) unsigned DEFAULT NULL COMMENT '[]',
  `ref_uniprot_id` int(10) unsigned DEFAULT NULL COMMENT '[]',
