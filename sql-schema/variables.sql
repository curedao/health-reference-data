...
CREATE TABLE `cd_variables` (
  ...
  `common_alias` varchar(125) DEFAULT NULL,
  ...
  `informational_url` varchar(2083) DEFAULT NULL,
  `ion_icon` varchar(40) DEFAULT NULL,
  ...
  `second_most_common_value` double DEFAULT NULL,
  ...
  `third_most_common_value` double DEFAULT NULL,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `variance` double DEFAULT NULL COMMENT 'Variance',
  `most_common_connector_id` int(10) unsigned DEFAULT NULL,
  `synonyms` varchar(600) DEFAULT NULL COMMENT 'The primary variable name and any synonyms for it. This field should be used for non-specific variable searches.',
  `wikipedia_url` varchar(2083) DEFAULT NULL,
  ...
  `upc_12` varchar(255) DEFAULT NULL,
  `upc_14` varchar(255) DEFAULT NULL,
  `number_common_tagged_by` int(10) unsigned DEFAULT NULL,
  `number_of_common_tags` int(10) unsigned DEFAULT NULL,
  ...
  `common_maximum_allowed_daily_value` double DEFAULT NULL,
  `common_minimum_allowed_daily_value` double DEFAULT NULL,
  `common_minimum_allowed_non_zero_value` double DEFAULT NULL,
  ...
  `manual_tracking` tinyint(1) DEFAULT NULL,
  ...
  `source_url` varchar(2083) DEFAULT NULL COMMENT 'URL for the website related to the database containing the info that was used to create this variable such as https://world.openfoodfacts.org or https://dsld.od.nih.gov/dsld ',
  `loinc_core_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
